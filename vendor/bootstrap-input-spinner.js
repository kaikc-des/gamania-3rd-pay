...
(function ($) {
	...
	$.fn.inputSpinner = function (methodOrProps) {
		...
		const props = {
			...
			template: '<div class="input-group ${groupClass}">' + '<button class="btn btn-decrement ${buttonsClass} btn-minus" type="button"><i class="bi bi-dash-lg"></i></button>' + '<input type="text" inputmode="decimal" style="text-align: ${textAlign}" class="form-control form-control-text-input"/>' + '<button class="btn btn-increment ${buttonsClass} btn-plus" type="button"><i class="bi bi-plus-lg"></i></button>' + "</div>",
		};
